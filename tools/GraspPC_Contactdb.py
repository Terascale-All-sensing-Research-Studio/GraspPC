...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    # trainval
    # training
    #NOTE: ContactDB does not train, just test
...
def test(base_model, test_dataloader,ChamferDisL1, ChamferDisL2, args, config, logger = None):
    ...
    with torch.no_grad():
        for idx, (filename_contactdb, data_input, number_used) in enumerate(test_dataloader):
            filename_contactdb = filename_contactdb[0]
            ...
            if  'PCN' in dataset_name or 'ProjectShapeNet'or "ContactDB" in dataset_name:
                input_object = data_input.cuda() if data_input is not None else None
                ...
                output_file = f"GraspPC/outputs/{name}/input_{filename_contactdb}_{number_used}.ply"
                ...
                output1_file_path = f"GraspPC/outputs/{name}/output1_pred_{filename_contactdb}_{number_used}.ply"
                output2_file_path = f"GraspPC/outputs/{name}/output2_pred_{filename_contactdb}_{number_used}.ply"
                output3_file_path = f"GraspPC/outputs/{name}/output3_pred_{filename_contactdb}_{number_used}.ply"
                output4_file_path = f"GraspPC/outputs/{name}/output4_pred_{filename_contactdb}_{number_used}.ply"
