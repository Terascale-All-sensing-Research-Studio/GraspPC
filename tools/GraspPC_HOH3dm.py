...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    for epoch in range(start_epoch, config.max_epoch + 1):
        ...
        for idx, (taxonomy_ids, model_ids, obj_ID_used, data_input, data_output) in enumerate(train_dataloader):
            ...
            for iqg in range(4):  # 4 = nqg
                ...
                if torch.sum(minindices == iqg) > 0:
                    if iqg == 0:
                        ...
                        total_loss_iqg1 = sparse_loss_iqg1 + dense_loss_iqg1 
                        ...
                        total_loss_iqg2 = sparse_loss_iqg2 + dense_loss_iqg2 
                        ...
                        total_loss_iqg3 = sparse_loss_iqg3 + dense_loss_iqg3 
                        ...
                        total_loss_iqg4 = sparse_loss_iqg4 + dense_loss_iqg4 
...
def test(base_model, test_dataloader,ChamferDisL1, ChamferDisL2, args, config, logger = None):
    ...
    with torch.no_grad():
        for idx, (taxonomy_ids, model_ids, obj_ID_used, data_input, data_output) in enumerate(test_dataloader):
            taxonomy_id = taxonomy_ids[0] if isinstance(taxonomy_ids[0], str) else taxonomy_ids[0].item()
            model_id = model_ids[0]
            obj_ID_used = obj_ID_used[0]
            sample_metrics = {}
            ...
            if  'PCN' in dataset_name or 'ProjectShapeNet'or "HOH_3dm"  in dataset_name: 
                input_object = data_input.cuda() if data_input is not None else None
                output_object  = data_output.cuda() if data_output is not None else None
