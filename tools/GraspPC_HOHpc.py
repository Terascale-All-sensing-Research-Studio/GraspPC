...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    for epoch in range(start_epoch, config.max_epoch + 1):
        ...
        for idx, (taxonomy_ids, model_ids, obj_ID_used, data_input, data_output) in enumerate(train_dataloader):
            ...
            if  'PCN' in dataset_name or dataset_name == 'Completion3D' or 'ProjectShapeNet' or "HOHpc" or in dataset_name: #
            ...
            total_losses = sparselosses + denselosses
            ...
            csv_file_name = "example"
            csv_file_path = f"GraspPC/losses/{csv_file_name}.csv"
    ...
    with torch.no_grad():
        for idx, (taxonomy_ids, model_ids, obj_ID_used, data_input, data_output) in enumerate(test_dataloader):
            ...
            if  'PCN' in dataset_name or 'ProjectShapeNet'or "HOHpc"  in dataset_name: 
                ...
                output2_file_path = f"GraspPC/outputs/{name}/output2_pred_{taxonomy_id}_{model_id}_{obj_ID_used}.ply"
                output3_file_path = f"GraspPC/outputs/{name}/output3_pred_{taxonomy_id}_{model_id}_{obj_ID_used}.ply"
                output4_file_path = f"GraspPC/outputs/{name}/output4_pred_{taxonomy_id}_{model_id}_{obj_ID_used}.ply"
